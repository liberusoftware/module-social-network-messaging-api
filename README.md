...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-messaging-api?sort=semver)](https://github.com/liberusoftware/module-social-network-messaging-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-messaging-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-messaging-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-messaging-api
```
...
<a href="https://github.com/liberusoftware/module-social-network-messaging-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-messaging-api" alt="Contributors to liberusoftware/module-social-network-messaging-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-messaging-api/graphs/contributors).
